...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        pessoa pessoa1 = new pessoa("Maro coco", 30, "111.222.333-44");
        pessoa1.mostrarDados();
        System.out.println();

        System.out.println("Testando Funcionario");
        funcionario funcionario1 = new funcionario("Jo Souza", 25, "555.666.777-88", "Desenvolvedor", "11/09/2001", 3000.00);
        ...
        Gerente gerente1 = new Gerente("Ana Paua", 40, "999.888.777-66", "Gerente de Projetos", "15/03/2020", 8000.00, 5, 1000.00);
